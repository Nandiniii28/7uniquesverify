  ...
  const features = [
    {
      ...
      icon: <FaRegSmileWink className="text-[#b7603d] text-xl mr-2" />,
    },
    {
      ...
      icon: <MdIntegrationInstructions className="text-[#b7603d] text-xl mr-2" />,
    },
    {
      ...
      icon: <AiOutlineThunderbolt className="text-[#b7603d] text-xl mr-2" />,
    },
  ];
      ...
      <div className="w-full mx-auto flex flex-col-reverse lg:flex-row items-start gap-12">
        ...
        <div className="w-full lg:w-1/2 space-y-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">
            Unlocking the <span className="text-[#b7603d]">Power of AI-Driven OCR</span> with 7Unique Verify
          </h2>
