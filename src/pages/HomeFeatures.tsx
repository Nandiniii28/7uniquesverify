            ...
            <div className="lg:w-1/3 p-10 bg-gradient-to-br from-[#ac7c6a] to-[#be7256] text-white lg:sticky lg:top-0  lg:min-h-[600px] flex flex-col justify-center relative overflow-hidden">
              ...
              >
                ...
                <motion.button 
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="mt-2 bg-white text-[#b7603d] font-semibold text-lg px-8 py-3 rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl flex items-center gap-2"
                >
