  ...
  return (
    <main className="w-full mx-auto">
      ...
      <section className="bg-white py-16 px-4 md:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            Where Can You Use <span className="text-[#29a9c5]">LEI Verification</span>?
          </h2>
          <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <div className="text-xs text-green-600 font-medium">"Compliance ready!"</div>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-lg text-center hover:shadow-lg transition-shadow">
              ...
              <div className="text-xs text-purple-600 font-medium">"Informed decisions!"</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-blue-500">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-blue-600 font-medium">Entity Validation</span>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-green-500">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-green-600 font-medium">Full Entity Profile</span>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>✓ Legal entity name and LEI</li>
                  <li>✓ LEI status (Active/Lapsed/Retired)</li>
              ...
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li>✓ Business registry ID</li>
                  <li>✓ Entity category</li>
                  <li>✓ Ownership structure</li>
                  <li>✓ Ultimate parent information</li>
      ...
      <section className="bg-white py-16 px-4 md:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            How <span className="text-[#29a9c5]">LEI Verification</span> Works
          </h2>
      ...
      <section className="bg-gray-50 py-16 px-4 md:px-8 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">
            Why Use Our <span className="text-[#29a9c5]">LEI Verification API</span>?
          </h2>
