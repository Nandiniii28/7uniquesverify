    ...
    <section className="bg-[#f6fafd] py-16 mt-14 rounded-lg">
      <div className="max-w-7xl mx-auto px-10 flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 flex flex-col items-start max-w-lg">
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#373533] mb-4">Join Hands with 7UniqueVerify to Redefine Digital Verification.
          </h2>
          <p className="text-[#595c5c] text-lg mb-8">We are passionate about transforming the way businesses verify and comply. Specializing in secure, API-driven identity and compliance solutions.
          </p>
          <a
            href="/contact-us"
