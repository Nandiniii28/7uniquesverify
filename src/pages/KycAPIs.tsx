  ...
  const apiServices = [
    {
      ...
      icon: <FaPassport />,
      description:
        "Instantly validate Indian and international passports for identity checks.",
    },
    {
      name: "PAN Verification",
      icon: <FaIdCard />,
      description:
        "Verify PAN details in real-time to ensure legal and tax compliance.",
    },
    {
      name: "Driving Licence Verification",
      icon: <FaCar />,
      description:
        "Authenticate DL records via government databases for secure user validation.",
    },
    {
      name: "Bank Account Verification",
      icon: <FaUniversity />,
      description:
        "Confirm beneficiary bank accounts using penny-drop or penny-less methods.",
    },
    {
      name: "Aadhaar Verification",
      icon: <FaMapMarkerAlt />,
      description:
        "Verify Aadhaar number with consent-based checks through UIDAI gateway.",
    },
    {
