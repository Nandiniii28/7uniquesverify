        ...
        <div className="container mx-auto px-4 py-12">
          <div className="mx-auto max-w-7xl space-y-12">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <p className="p-4">Comprehensive solutions to verify driving licenses with accuracy and speed</p>
              <div className="p-8">
                <motion.div
                  initial="hidden"
                  whileInView="visible"
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-6xl space-y-8">
          ...
          >
            ...
            <p className="p-4 text-start">Simple steps to verify driving licenses with our robust API</p>
        ...
        <div className="mx-auto max-w-6xl space-y-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            >
              ...
              <p className="p-4 text-start">Discover how different industries leverage our driving license verification API</p>
              <div className="w-24 h-1.5 bg-gradient-to-r from-[#b7603d] to-[#d88a6e] mx-auto rounded-full" />
            </motion.div>
              ...
              <div className="grid gap-10 grid-cols-1 md:grid-cols-2 text-left">
                <div className="bg-white p-6 rounded-lg shadow-xl transition duration-300 hover:shadow-2xl border border-gray-100 hover:border-[#b7603d]/30">
                  ...
                  <p className="text-gray-600 mt-5">
                   Integrate 7UniqueVerify's Driving License Verification API into your platform effortlessly. Our solution supports license checks across all Indian states with rich and real-time driver data.
                  </p>
