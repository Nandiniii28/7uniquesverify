...
">
        <div className="container mx-auto px-16">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Email Verification Features by <span className="text-[#b7603d]">7Unique Verify</span>
            </h2>
 ...
 p-3 rounded-full w-16 h-16 flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#b7603d]  " fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Benefits of <span className="text-[#b7603d]">7Unique Verify</span> Email Authentication
              </h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#b7603d]   mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-16">
        <div className="container mx-auto px-16">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Email authentication is essential across various industries for maintaining communication quality and security.
            </p>
          </div>
 ...
 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-[#b7603d]  " fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-2">E-commerce</h3>
              <p className="text-gray-600">Verify customer emails during registration and checkout to ensure order confirmations reach customers.</p>
            </div>
 ...
 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Clean email lists before campaigns to improve deliverability and engagement rates.</p>
            </div>
 ...
 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Validate user emails during signup to ensure legitimate users and reduce fraud.</p>
            </div>
 ...
 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Ensure secure communication channels for sensitive financial information and notifications.</p>
            </div>
 ...
 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Verify patient contact information for appointment reminders and health communications.</p>
            </div>
 ...
 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600">Validate student and parent email addresses for academic communications and notifications.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-16">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <p className="text-gray-600 mb-8">
                Integrate email authentication into your application with just a few lines of code. Our RESTful API is designed for developers.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#b7603d]   mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className="flex items-start">
                  ...
                  <span>SDKs available for popular programming languages</span>
                </li>
              </ul>
            </div>
            <div className="md:w-1/2">
              <div className="bg-gray-900 text-green-400 p-6 rounded-lg font-mono text-sm overflow-x-auto">
                <div className="text-gray-500 mb-2">// Email Authentication API Example</div>
                ...
                <span className="text-blue-400">https://api.example.com/v1/email/verify</span>
                <br /><br />
                <div className="text-gray-500">// Response</div>
                <div className="text-white">{'{'}</div>
                <div className="ml-4 text-blue-300">"valid"</div>: <span className="text-green-300">true</span>,<br />
                <div className="ml-4 text-blue-300">"deliverable"</div>: <span className="text-green-300">true</span>,<br />
                <div className="ml-4 text-blue-300">"disposable"</div>: <span className="text-red-300">false</span>,<br />
                <div className="ml-4 text-blue-300">"risk_score"</div>: <span className="text-yellow-300">0.1</span><br />
                <div className="text-white">{'}'}</div>
              </div>
            </div>
          </div>
